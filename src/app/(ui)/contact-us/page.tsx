...
const ContactUs = () => {
  return (
    <>
      ...
      <section className="flex flex-col gap-5 lg:gap-4 lg:flex-row items-center mx-9 lg:mx-11 mt-10 mb-20 max-w-screen-xl xl:mx-auto">
        ...
        <div className="w-full lg:min-h-[520px] lg:w-1/2 p-10 flex items-center justify-center lg:rounded-md  border border-b border-t-0 border-gray-50 shadow-lg h-full  rounded-md">
          <ProblemForm />
        </div>
      </section>
    </>
